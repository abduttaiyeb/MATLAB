...
% ADVANCE MATLAB code for advance.fig
...
% Last Modified by GUIDE v2.5 14-Mar-2019 02:09:45
...
function advance_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes advance wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = advance_OutputFcn(hObject, eventdata, handles) 
